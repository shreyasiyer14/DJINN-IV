...
setup(
    ...
    packages=['djinn', 'djinn/math', 'djinn/scenes/textures', 'djinn/scenes/prefabs/', 'djinn/scenes', 'djinn/player', 'djinn/window/', 'djinn/scenes/shapes', 'djinn/physics', 'djinn/widgets'],
